...
export const track = [
  ...
  },
  {
    ...
    body: '외국인 고객을 영어·중국어·일본어로 응대합니다. 찾으시는 제품의 재고가 없으면 비슷한 제품을 권해드리고, 그것도 맞지 않으면 온라인이나 인근 지점 재고를 확인해 안내합니다.\n\n이 순서 가운데 매장에서 바로 이어지는 구간을 옮긴 것이 OY-trans의 문구 체인입니다. 품절을 알린 다음 피부 타입을 묻고, 답에 따라 추천과 테스터 안내로 이어집니다.',
    points: [
      '다국적 고객의 결제 · 택스리펀 · 할인 적용 응대',
      '재고가 없을 때 대체 상품 → 온라인 → 인근 지점 순으로 안내',
      '그중 매장에서 바로 이어지는 구간을 OY-trans의 문구 체인으로 구현',
    ],
  },
] as const
