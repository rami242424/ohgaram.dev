...
export const caseStudy = {
  ...
  blocks: [
    ...
    },
    {
      ...
      body: '매장에서 나오는 질문은 대체로 정해져 있습니다. 그래서 그때그때 번역하는 대신 안내를 미리 문구로 만들어두고, 탭 한 번으로 고객 화면에 띄우게 했습니다. 매장에서 배운 MOT 응대 기준에 맞춰 문구를 쓰고 6개 카테고리로 나눴습니다. 언어 14개는 매장에 방문하는 고객의 국적 분포를 보고 골랐습니다.',
      list: [
    ...
    },
    {
      ...
      body: '영어로 안내해도 소통이 되지 않을 때, 고객은 번역기를 켜 자국어로 입력하기 시작합니다. 그동안 전달하려는 응대 문구를 앱에서 찾아 화면을 보여줍니다.\n\n고객이 번역 버튼을 누르기 전에 앱의 문구로 해결되는 경우가 많아졌습니다. 결제 고객에게 쓸 때는 고객이 입력을 마치기도 전에 문구를 띄울 수 있습니다.\n\n응대 시간을 초 단위로 재보지는 않았습니다. 다만 안내가 끝나고 바로 다음 고객을 받을 수 있다는 것은 매 근무마다 확인하고 있습니다.',
    },
    {
      no: '07',
      ...
      list: [
        {
          label: '크루 요청',
          text: '다른 매장에서 구매한 올리브영 쇼핑백이나 개인 가방에 상품을 담는 경우가 자주 있었습니다.\n\n이런 경우 결제가 완료된 고객인지 혼동이 되는 문제가 발생합니다. 사전에 이러한 문제를 방지하기 위해 크루들의 요청으로 "상품은 개인가방이 아니라, 매장 장바구니에 담아 이용해 주세요"라는 문구를 추가했습니다. 이런 요청 문구는 매장에서 직접 사용하면서 계속 늘려가고 있습니다.',
        },
        {
          label: '쇼핑백 흐름',
          text: '전시된 쇼핑백을 고객이 손가락으로 가리킬 때 어느 쪽인지 애매할 때가 있습니다. 앱에서 버튼으로 직접 눌러 고를 수 있게 바꾸니, 정확한 가격을 확정해 오안내를 줄일 수 있었습니다.',
        },
        {
          label: '즐겨찾기 버그',
          text: '처음 설계 당시에는 문구 id만 저장해 사용했으나, 문구를 정리하며 id를 다시 매기자 엉뚱한 문구가 등록되어 있었습니다. 화면이 깨지지 않아 한참 뒤에야 버그임을 알게 됐습니다. id와 원문을 함께 저장해 둘 다 일치할 때만 유효하도록 바꾼 뒤에 해결할 수 있었습니다.',
        },
      ],
    },
    {
