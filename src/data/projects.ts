...
export const caseStudy = {
  ...
  blocks: [
    ...
    },
    {
      ...
      body: '매장에서 나오는 질문은 대체로 정해져 있습니다. 그래서 그때그때 번역하는 대신 안내를 미리 문구로 만들어두고, 탭 한 번으로 고객 화면에 띄우게 했습니다. 매장에서 배운 MOT 응대 기준에 맞춰 문구를 쓰고 여섯 개 카테고리로 나눴습니다. 언어 14개는 매장에 오시는 고객의 국적 분포를 보고 골랐습니다.',
      list: [
        '결제 15개 · 택스리펀 8개 · 교환/기내반입 11개',
        '재고 7개 · 추천 48개 · 기타 10개',
        '여기에 상품 위치를 알려주는 매장 지도를 더했습니다. 구역 27개를 좌표로 찍어두고 현위치와 목적지를 함께 표시합니다.',
      ],
      evidenceTitle: '응대 단계가 넷에서 둘로 줄었습니다',
    ...
    },
    {
      ...
      evidence: '체인 문구의 기준은 "고객이 응답했을 때 크루가 알아듣기 어려운 질문인가"였습니다.\n\n카드를 꺼내면 답이 보이는 질문은 제외하고, 99개 중 11개에만 적용했습니다.',
    },
    {
      no: '04',
      title: '두 구조를 하나로 줄였습니다',
      body: '다음 문구가 하나로 정해진 경우와, 답에 따라 갈라지는 경우가 둘 다 필요했습니다.\n\n처음에는 두 가지를 각각 다른 구조로 만들려고 했습니다. 그런데 하나로 이어지는 것도 결국 갈래가 하나뿐인 경우였습니다. 갈래 구조 하나로 둘 다 표현할 수 있었습니다.\n\n선택지를 배열에 담아두면 개수가 하나든 셋이든 같은 코드로 그립니다. 문구가 늘어나도 데이터만 추가하면 됩니다.',
      list: [
    ...
    },
    {
      ...
      body: '14개 언어의 번역은 API로 만들었습니다. 모든 언어가 완벽하지는 않기 때문에, 몇 개의 언어는 현지에 있거나 해당 언어를 전공한 지인들에게 부탁해 검수를 받았습니다.\n\n추후 여러 번역 앱으로 비교해 검수해 나갈 예정입니다.',
    },
    {
      no: '06',
      title: '고객이 번역 버튼을 누르기 전에',
      body: '영어로 안내해도 이해하지 못하시면, 고객은 번역기를 켜고 자국어를 입력하기 시작합니다. 그 순간 앱에서 해당 언어 문구를 띄웁니다.\n\n고객이 번역 버튼을 누르기 전에 화면을 먼저 읽으시는 경우가 많습니다.',
      evidence: '응대 시간을 초 단위로 재보지는 않았습니다.\n\n다만 결제 고객에게 사용할 때, 고객이 번역기 입력을 마치기도 전에 해당 문구를 보여줄 수 있습니다. 안내가 끝나고 다음 고객을 받을 수 있다는 것은 매 근무마다 확인하고 있습니다.',
    },
    {
      no: '07',
      ...
      list: [
        '크루 요청 — 다른 매장에서 구매한 올리브영 쇼핑백이나 개인 가방에 상품을 담는 경우가 자주 있었습니다. 이런 경우 결제가 완료된 고객인지 혼동이 되는 문제가 발생합니다.\n\n사전에 이러한 문제를 방지하기 위해 크루들의 요청으로 "상품은 개인가방이 아니라, 매장 장바구니에 담아 이용해 주세요"라는 문구를 추가했습니다. 이런 요청 문구는 매장에서 직접 사용하면서 계속 늘려가고 있습니다.',
        '쇼핑백 흐름 — 전시된 쇼핑백을 고객이 손가락으로 가리킬 때 어느 쪽인지 애매할 때가 있습니다. 앱에서 버튼으로 직접 눌러 고를 수 있게 바꾸니, 정확한 가격을 확정해 오안내를 줄일 수 있었습니다.',
        '즐겨찾기 버그 — 처음 설계 당시에는 문구 id만 저장해 사용했으나, 문구를 정리하며 id를 다시 매기자 엉뚱한 문구가 등록되어 있었습니다. 화면이 깨지지 않아 한참 뒤에야 버그임을 알게 됐습니다.\n\nid와 원문을 함께 저장해 둘 다 일치할 때만 유효하도록 바꾼 뒤에 해결할 수 있었습니다.',
      ],
    },
    {
      no: '08',
