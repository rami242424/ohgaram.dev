...
export const caseStudy = {
  ...
  blocks: [
    ...
    },
    {
      ...
      body: '영어로 안내해도 소통이 되지 않을 때, 고객은 번역기를 켜 자국어로 입력하기 시작합니다. 그동안 전달하려는 응대 문구를 앱에서 찾아 화면을 보여줍니다. 고객이 번역 버튼을 누르기 전에 앱의 문구로 해결되는 경우가 많아졌습니다. 결제 고객에게 쓸 때는 고객이 입력을 마치기도 전에 문구를 띄워 빠르게 해결 할 수 있습니다.',
    },
    {
      no: '07',
